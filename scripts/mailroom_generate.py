...
OpenAI-compatible generate against PROCESS=mlx_lm.server.
Ollama is never used to generate. Fail-open is hits-only and labeled
fail-open-only. Success path string llmster-headless may stay in code —
it is not the process and is not a product-name claim.
"""
